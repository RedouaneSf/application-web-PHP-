                                ...
                                <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <a href="listAllusers.php"><button type="submit" class="btn btn-info btn-lg my-4" name="ajouter">Plus...</button></a>
                                            </div>
                                        </div>
                                </div>
                    </div>
                                ...
                                <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <a href="listAllarticle.php"><button type="submit" class="btn btn-info btn-lg my-4" name="ajouter">Plus...</button></a>
                                            </div>
                                        </div>
                                </div>
                    </div>
